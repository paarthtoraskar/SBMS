...
namespace SBMS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    Roles.AddUserToRole(model.Username, "public");
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            {
                // User does not have a local password so remove any validation errors caused by a
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (var _db = new UsersContext())
                {
                    ...
                    ModelState.AddModelError("Username", "Username already exists. Please enter a different user name.");
                }
            }
